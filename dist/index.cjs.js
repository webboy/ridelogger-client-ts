...
class RideLoggerClient {
    constructor(apiKey = process__namespace.env.API_KEY, baseURL = process__namespace.env.RIDE_LOGGER_API_URL || DEFAULT_CONFIG.baseURL) {
...
exports.RLCountry = RLCountry;
exports.RLCurrency = RLCurrency;
exports.RLSystem = RLSystem;
exports.RLVehicleMake = RLVehicleMake;
exports.RLVehicleModel = RLVehicleModel;
exports.RideLoggerClient = RideLoggerClient;
